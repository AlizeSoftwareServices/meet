    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-blue/5 via-background to-brand-purple/5 selection:bg-brand-blue/20 overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/60 backdrop-blur-xl border-b border-white/10 dark:border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between relative">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-brand-blue via-brand-purple to-brand-red flex items-center justify-center shadow-lg shadow-brand-purple/30">
              <Sparkles className="w-5 h-5 text-white" />
            </div>
            <span className="font-extrabold text-xl tracking-tight text-foreground">Meeting</span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8 absolute left-1/2 -translate-x-1/2 h-full">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <div className="w-[600px] bg-background border border-border shadow-2xl rounded-2xl p-6 flex gap-6">
                  ...
                  <div className="flex-1 space-y-5">
                    ...
                    <Link href="/dashboard/events" className="flex items-start gap-4 p-3 rounded-xl hover:bg-brand-blue/5 transition-colors group/item">
                    ...
                    <Link href="/dashboard/availability" className="flex items-start gap-4 p-3 rounded-xl hover:bg-brand-purple/5 transition-colors group/item">
                    ...
                    <Link href="/dashboard/bookings" className="flex items-start gap-4 p-3 rounded-xl hover:bg-brand-red/5 transition-colors group/item">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">Manage and view all your meetings.</p>
                      </div>
                    </Link>
                  </div>
                  ...
                  <div className="flex-1 bg-muted/40 rounded-xl p-5 space-y-5 border border-border/50">
                    ...
                    <Link href="/dashboard/integrations" className="flex items-start gap-4 p-2 rounded-xl hover:bg-background transition-colors group/item">
                    ...
                    <Link href="/dashboard/analytics" className="flex items-start gap-4 p-2 rounded-xl hover:bg-background transition-colors group/item">
                      <div className="w-8 h-8 rounded-lg bg-background shadow-sm border border-border/50 flex items-center justify-center shrink-0">
                        <BarChart3 className="w-4 h-4 text-foreground" />
                      </div>
                      <div>
                        <h5 className="text-sm font-bold text-foreground group-hover/item:text-foreground">Analytics</h5>
                        <p className="text-xs text-muted-foreground mt-0.5">Track meeting trends and insights.</p>
                      </div>
                    </Link>
                  </div>
                </div>
            ...
            <Link href="#contact" className="text-sm font-bold text-foreground hover:text-brand-blue transition-colors">Contact</Link>
          </div>

          <div className="flex items-center gap-6">
            <Link href="/login" className="text-sm font-semibold hover:text-brand-purple transition-colors">
              Log In
            </Link>
            <Link href="/register">
              <Button className="rounded-full bg-foreground text-background hover:bg-brand-blue hover:text-white shadow-xl hover:shadow-brand-blue/30 transition-all duration-300 px-6 font-semibold">
      ...
      <main className="pt-32 pb-20 px-6 max-w-7xl mx-auto relative min-h-[85vh]">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8 pt-8">
          ...
          >
            <h1 className="text-6xl sm:text-7xl lg:text-[80px] font-black tracking-tight leading-[1.05] text-foreground">
              Easy <br className="hidden sm:block" />
            ...
            <p className="text-xl text-muted-foreground max-w-lg leading-relaxed font-medium">
              Join millions of professionals who easily book meetings and automate their workflows with the #1 scheduling tool.
            </p>
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pt-2">
              <Link href="/register">
                <Button size="lg" className="rounded-full text-lg px-8 h-14 bg-gradient-to-r from-brand-blue to-brand-purple text-white shadow-xl shadow-brand-blue/30 hover:shadow-brand-purple/40 hover:scale-105 transition-all duration-300 font-bold">
                  Sign up for free
                </Button>
              </Link>
              <p className="text-sm text-muted-foreground font-medium">No credit card required.</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div>
              <h2 className="text-4xl sm:text-5xl font-black text-foreground mb-4">
                Connect MeetSync to the<br />tools you already use
              </h2>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-4">
              {[
                { 
                  name: 'Zoom', 
                  bg: 'bg-[#2D8CFF]', 
                  icon: <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor"><path d="M4.585 13.607l-.27-.012H1.886l3.236-3.237-.013-.27a.815.815 0 00-.796-.796l-.27.013H.806L4.043 6.07l-.013-.27a.815.815 0 00-.796-.796l-.27.013H0v7.316c0 1.63 1.342 2.972 2.972 2.972h7.318v-2.972H6.052l-1.467-1.467v2.664z" /><path d="M14.52 10.393l.27.012h2.428l-3.236 3.237.013.27c.032.43.366.764.796.796l.27-.013h3.237l-3.237 3.236.013.27c.032.43.366.764.796.796l.27-.013H24v-7.316c0-1.63-1.342-2.972-2.972-2.972h-7.318v2.972h4.238l1.467 1.467v-2.664z" /></svg> 
                },
                { 
                  name: 'Slack', 
                  bg: 'bg-[#4A154B]', 
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-muted-foreground font-medium max-w-sm">
                  Get your job done faster by connecting MeetSync to Google Calendar and Google Meet to automate your scheduling.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground font-medium max-w-sm">
                  Make your day easier with MeetSync integrations for Microsoft Teams and Outlook Calendar.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      <section className="py-40 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-2xl text-muted-foreground mb-12 font-medium">Start scheduling meetings efficiently with MeetSync today.</p>
          <Link href="/register">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-16">
            <div className="col-span-2 lg:col-span-1">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-brand-blue via-brand-purple to-brand-red flex items-center justify-center shadow-md">
              ...
              <div className="flex gap-4 text-muted-foreground">
                <Link href="#" className="hover:text-brand-blue transition-colors"><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg></Link>
                <Link href="#" className="hover:text-brand-purple transition-colors"><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.88z"/></svg></Link>
                <Link href="#" className="hover:text-brand-red transition-colors"><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg></Link>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground font-medium">
                <li><Link href="/dashboard" className="hover:text-brand-blue transition-colors">Scheduling automation</Link></li>
                <li><Link href="/dashboard/availability" className="hover:text-brand-blue transition-colors">Customizable availability</Link></li>
                <li><Link href="/dashboard/events" className="hover:text-brand-blue transition-colors">Event Types</Link></li>
                <li><Link href="/dashboard/bookings" className="hover:text-brand-blue transition-colors">Bookings management</Link></li>
                <li><Link href="/dashboard/analytics" className="hover:text-brand-blue transition-colors">Analytics & Insights</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground font-medium">
                <li><Link href="/dashboard/integrations" className="hover:text-brand-red transition-colors">Google Calendar</Link></li>
                <li><Link href="/dashboard/integrations" className="hover:text-brand-red transition-colors">Google Meet</Link></li>
                <li><Link href="/dashboard/integrations" className="hover:text-brand-red transition-colors">Microsoft Teams</Link></li>
                <li><Link href="/dashboard/integrations" className="hover:text-brand-red transition-colors">Zoom</Link></li>
                <li><Link href="/dashboard/integrations" className="hover:text-brand-red transition-colors">Slack</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground font-medium">
                <li><Link href="#" className="hover:text-brand-green transition-colors">Help center</Link></li>
                <li><Link href="#" className="hover:text-brand-green transition-colors">Blog</Link></li>
                <li><Link href="#" className="hover:text-brand-green transition-colors">Developer tools</Link></li>
                <li><Link href="#" className="hover:text-brand-green transition-colors">Release notes</Link></li>
              </ul>
            </div>
            ...
            <div id="contact">
              ...
              <ul className="space-y-3 text-sm text-muted-foreground font-medium">
                <li>HQ: +91 86107 01675</li>
                <li>Admin: 04362 284583</li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-border/50">
            <div className="text-sm text-muted-foreground font-medium">
              <p>&copy; {new Date().getFullYear()} Meeting. All rights reserved.</p>
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm font-bold text-foreground">
              ...
              <Link href="#" className="hover:text-brand-red transition-colors">Security</Link>
            </div>
          </div>
        </div>
      </footer>
